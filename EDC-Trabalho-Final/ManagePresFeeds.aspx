<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManagePresFeeds.aspx.cs" Inherits="EDC_Trabalho_Final.ManagePresFeeds" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:LinkButton ID="PresidentNews" PostBackUrl="~/PresidentNews.aspx" runat="server" CssClass="btn btn-primary"><i class="fa fa-rss"></i>&nbsp;PresidentNews</asp:LinkButton>
